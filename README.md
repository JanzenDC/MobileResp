...
`pnpm build` writes the landing page into `dist` (including `mobile-resp.zip`) so Vercel can serve it. Use `corepack pnpm zip` when you only need the unpacked extension.
